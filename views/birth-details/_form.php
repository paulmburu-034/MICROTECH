...
<div class="card">
    ...
    <div class="card-content collapse show">
        ...
        <div class="row">
            <div class="col-md-6">
                <?= $form->field($model, 'DocumentofRegistration')->dropDownList(['Identity Card'=>'Identity Card','Birth Notification'=>'Birth Notification'],['prompt'=>'Select Document of Registration','data-validation'=>'required'])->label('<b>Document of Registration</b>') ?>
            </div>
            <div class="col-md-6">
