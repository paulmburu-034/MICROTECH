...
class BirthDetails extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['BirthCertNo'], 'required'],
            [['BirthCertNo', 'CountyID', 'ConstituencyID', 'IsDead', 'CreatedBy', 'UpdatedBy', 'RegistrationCenterID'], 'integer'],
            [['DateofBirth', 'CreatedDate', 'UpdatedDate'], 'safe'],
            [['FullName', 'MothersName', 'FathersName', 'DocumentNumber'], 'string', 'max' => 250],
            [['Gender', 'DocumentofRegistration'], 'string', 'max' => 50],
            [['BirthCertNo'], 'unique'],
        ];
    }
